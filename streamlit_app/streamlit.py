...
if getattr(sys, 'frozen', False):
    ...
    model_path = os.path.join(sys._MEIPASS, r'C:\Users\ELEKTROGEN2\Downloads\AOI_webUI-master\streamlit_app\best_F3.pt')
else:
    # If running in a normal environment, use the usual path
    model_path = r'C:\Users\ELEKTROGEN2\Downloads\AOI_webUI-master\streamlit_app\best_F3.pt'
